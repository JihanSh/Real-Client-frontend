...
const About = () => {
  ...
  return (
    ...
    <Box p={{ xs: 3, sm: 4, md: 12 }} mb={-10} ml={{ xs: 2, sm: 3, md: 32 }} mt={{ xs: -3, sm: -4, md: -10 }} >
    ...
    <Box mt={{ xs: 6, sm: 4, md: -1 }} ml={{ xs: 2, sm: 4, md: 32 }} p={{ xs: 2, sm: 4, md: 6 }}>
        ...
        <Grid item xs={12} md={6} >
          <Box  p={{ xs: 2, sm: 4 }}  display="flex" alignItems="center" >
            <Box display="flex" alignItems="center" >
             <a  href="https://www.facebook.com/ZONE.Outlet.0?mibextid=LQQJ4d"> <FacebookIcon color="primary" fontSize="large" style={iconStyle} /></a>
             <a href="https://instagram.com/_zone_outlet_?igshid=YmMyMTA2M2Y="> <InstagramIcon color="primary" fontSize="large" style={iconStyle} /> </a>
            </Box>
            <Box ml={{ xs: 2, sm: 4 }} >
              <Typography variant={variant} gutterBottom>
                Follow Us
